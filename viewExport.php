...
if (isset($_GET['viewExport'])){
  $_SESSION['viewExport'] = $_GET['viewExport'];
  $_SESSION['editfile'] = "invoice";
...
<input id="email1sss" value="2" type="radio"><i class="icon-remove icon-white"></i>Manifest
  ...
  <?php
  if(isset($_GET['viewExport'])){
 $view=$_GET['viewExport'];
 ?>
<div class="row">
<center><strong><h5>Result</h5></strong></center>
 <table  width="100%"  border='2' align="center" style="background-color: grey;">
                ...
                <tr>
                    ...
                    <th width="25%" style="color: #F7990D;">Transport</th>
                ...
                <tbody>
<?php
 $stmt = $DB_con->prepare('SELECT * FROM tbl_stacksExport WHERE id=:uid');
           ...
           <?php
                 ...
                 echo '</td>';
                  echo '<td width="13%">';
                    ?>
    <center><h4><?php echo $row['numberOfBillOfLading']; ?></h4></center>
    <center><a href="#" data-toggle="modal" data-target="#bolModalRe-export" data-whatever12=<?php echo $row['id'];?> ><span class="badge badge-warning" style="background-color: green;"><p style="color: white;">View</p></span></center>
                    <?php
                 echo '</td>';
                  //CFS Name
                  echo '<td width="13%">';
