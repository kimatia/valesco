...
var fieldlimiteroverlay={

defaultoutput: "<b>[int]</b> characters remaining in overlay field.", //default message that gets output to statusid element
...
setup:function(config){
	if (config.thefield){ //if form field exists
		...
		this.addEvent([window], function(e){fieldlimiteroverlay.showlimit(config)}, "load")
		this.addEvent([window], function(e){fieldlimiteroverlay.cleanup(config)}, "unload")
		this.addEvent([config.thefield], function(e){return fieldlimiteroverlay.limitinput(e, config)}, "keypress")
		this.addEvent([config.thefield], function(){fieldlimiteroverlay.showlimit(config)}, "keyup")
	}
}
