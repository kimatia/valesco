...
var fieldlimitercontent={

defaultoutput: "<b>[int]</b> characters remaining in content field.", //default message that gets output to statusid element
...
setup:function(config){
	if (config.thefield){ //if form field exists
		...
		this.addEvent([window], function(e){fieldlimitercontent.showlimit(config)}, "load")
		this.addEvent([window], function(e){fieldlimitercontent.cleanup(config)}, "unload")
		this.addEvent([config.thefield], function(e){return fieldlimitercontent.limitinput(e, config)}, "keypress")
		this.addEvent([config.thefield], function(){fieldlimitercontent.showlimit(config)}, "keyup")
	}
}
